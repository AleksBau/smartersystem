...
const services = [
  ...
  { icon: '🔒', title: 'Sicherheit', desc: 'Alarmanlage, Überwachungskameras und die zuverlässige Absicherung von Fenstern und Türen. Automatische Reaktionen bei Abwesenheit.' },
...
const housePoints = [
  ...
  { label: 'Sicherheit', icon: '🔔', tip: 'Alarmanlage mit Absicherung von Fenstern und Türen', style: { top: '62%', left: '48%' } },
  ...
  return (
    <>
      ...
      <section id="start" className="min-h-[91vh] flex items-center justify-center relative overflow-hidden text-center px-[5%] py-28"
        style={{ background: 'linear-gradient(160deg, #1246C8 0%, #1A56E8 20%, #2a8fd4 100%)' }}>
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <p className="text-white/85 text-lg mb-8">
            Komplettpakete ab <span className="font-bold text-white">1.249 €</span> – installiert, eingerichtet und erklärt.
          </p>
